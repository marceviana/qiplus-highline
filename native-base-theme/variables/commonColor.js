...
export default {
  ...
  toolbarDefaultBg: platform === 'ios' ? '#F8F8F8' : '#ee1d67',
  ...
  toolbarDefaultBorder: platform === 'ios' ? '#a7a6ab' : '#ee1d67',
  get statusBarColor() {
  ...
  radioSelectedColorAndroid: '#ee1d67',
  ...
  // Segment
  segmentBackgroundColor: platform === 'ios' ? '#F8F8F8' : '#ee1d67',
  segmentActiveBackgroundColor: platform === 'ios' ? '#007aff' : '#fff',
  segmentTextColor: platform === 'ios' ? '#007aff' : '#fff',
  segmentActiveTextColor: platform === 'ios' ? '#fff' : '#ee1d67',
  ...
  // Tab
  tabDefaultBg: platform === 'ios' ? '#F8F8F8' : '#ee1d67',
